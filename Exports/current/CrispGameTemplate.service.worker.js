...
/** @type {string} */
const CACHE_VERSION = '1751824806|590714998';
/** @type {string} */
const CACHE_PREFIX = 'CrispGameTemplat-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'CrispGameTemplate.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["CrispGameTemplate.html","CrispGameTemplate.js","CrispGameTemplate.offline.html","CrispGameTemplate.icon.png","CrispGameTemplate.apple-touch-icon.png","CrispGameTemplate.audio.worklet.js","CrispGameTemplate.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["CrispGameTemplate.wasm","CrispGameTemplate.pck"];
